...
const timer_cfg_t g_timer11_cfg = { .mode = TIMER_MODE_PWM,
/* Actual period: 0.02 seconds. Actual duty: 50%. */.period_counts =
		(uint32_t) 0x4c4b40, .duty_cycle_counts = 0x2625a0, .source_div =
...
/** If NULL then do not add & */
    ...
    .p_context           = NULL,
		...
		.p_context = (void*) &NULL,
#endif
		.p_extend = &g_timer11_extend, .cycle_end_ipl = (BSP_IRQ_DISABLED),
...
const timer_instance_t g_timer11 = { .p_ctrl = &g_timer11_ctrl, .p_cfg =
		&g_timer11_cfg, .p_api = &g_timer_on_gpt };
...
/** If NULL then do not add & */
    ...
    .p_context           = NULL,
		...
		.p_context = (void*) &NULL,
#endif
		.p_extend = &g_timer2_extend, .cycle_end_ipl = (BSP_IRQ_DISABLED),
...
/* Baud rate calculated with 0.160% error. */.baudrate_bits_b.abcse = 0,
		...
		.baudrate_bits_b.cks = 0, .baudrate_bits_b.brr = 25,
...
const timer_cfg_t g_timer1_cfg =
		{ .mode = TIMER_MODE_PWM,
				/* Actual period: 0.000111108 seconds. Actual duty: 69.99675990927746%. */.period_counts =
						(uint32_t) 0x6c81, .duty_cycle_counts = 0x4bf3,
    ...
    .p_context           = NULL,
				...
				.p_context = (void*) &NULL,
#endif
				.p_extend = &g_timer1_extend, .cycle_end_ipl =
						(BSP_IRQ_DISABLED),
